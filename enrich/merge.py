...
def merge_files(outfile, data_path):
...
""")
        with open(data_path +'/'+ 'OCRDocumentNodes.graphml', 'r', encoding='utf8') as file:
            for line in file.readlines():
                out.write(line)
        with open(data_path +'/'+ 'WikiNodes.graphml', 'r', encoding='utf8') as file:
            for line in file.readlines():
                out.write(line)
...
""")
        with open(data_path +'/'+ 'DocContainsEntEdges.graphml', 'r', encoding='utf8') as file:
            for line in file.readlines():
                out.write(line)
        with open(data_path +'/'+ 'SameAsEdges.graphml', 'r', encoding='utf8') as file:
            for line in file.readlines():
                out.write(line)
            out.write("""</graph>
</graphml>""")
